...
public class DefaultPollingSchedule extends PollingSchedule {
     ...
     */
    public static final String DURATION_PROPERTY = "com.dhemery.expressions.polling.duration.millis";

    /**
     * The key for the system property that defines this schedule's default polling interval.
     */
    public static final String INTERVAL_PROPERTY = "com.dhemery.expressions.polling.interval.millis";
