...
public interface Expressions {
     ...
     * <p>
     * NOTE:
     * If the subject is a {@code String},
     * Java is able to decide whether to call this method
     * or {@link #assertThat(String, Object, Matcher)}
     * <em>only if:</em>
     * </p>
     * <ul>
     * <li>it knows the exact type of the function</li>
     * <li>it knows the exact type of the matcher</li>
     * </ul>
     * @throws AssertionError with a diagnostic description if the assertion fails
     */
    // TODO: Describe how to get Java to know the exact types of the function and matcher
