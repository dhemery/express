 ...
 * <p>
 * This class is not intended for direct use. Instead, call {@link Timeframes#within}.
 */
public class Within extends PollingSchedule {
    /**
     * Creates a polling schedule with the given interval and duration.
     * <p>
     * This constructor is not intended for direct use. Instead, call {@link Timeframes#within}.
     *
     * @param interval
    ...
    /**
     * Creates a polling schedule with the given interval and this schedule's duration.
     *
     * @param interval
     *         the interval on which to poll
     *
